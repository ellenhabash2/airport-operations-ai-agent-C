...
public:
    ...
    ADD_METHOD_TO(RunwayController::getRunwayByCodeQuery, "/runways/code", Get);
    ...
    void getRunwayByCodeQuery(const HttpRequestPtr &req, std::function<void(const HttpResponsePtr &)> &&callback);
